[project2-f2d7] Operating Details
====================================

Generated On: 2024-10-17 17:18:18 UTC
...
.. important::
   ...
   **not be valid if your [project2-f2d7] container is NOT running**.

.. tip::
   You must have your [project2-f2d7] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Defendx3/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=34747  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Defendx3'  \-\-env DOCKERUSERNAME='defendx'  \-\-env MQTTUSERNAME='defendx3@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   defendx/project2-f2d7-amd64 (https://hub.docker.com/r/defendx/project2-f2d7-amd64)
...
.. important::
   docker run -d -p 36577:36577 -p 53645:53645 -p 38659:38659 \-\-env TSS=0 \-\-env SOLUTIONNAME=project2-f2d7 \-\-env SOLUTIONDAG=solution_preprocessing_dag-project2-f2d7 \-\-env GITUSERNAME=Defendx3  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=36577  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=53645  \-\-env SOLUTIONVIPERVIZPORT=38659 \-\-env DOCKERUSERNAME='defendx'  \-\-env EXTERNALPORT=34747 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='defendx3@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  defendx/project2-f2d7-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=38659
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=36577
...
It can be accessed by entering: http://localhost:53645
...
.. important::
   http://localhost:38659/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:38659/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:38659/<html file>
...
[project2-f2d7] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Defendx3/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/project2-f2d7
...
.. important::
   https://project2-f2d7.readthedocs.io
...
.. important::
   solution_preprocessing_dag-project2-f2d7
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.1, VIPERPORT_PRODUCE=36577, VIPERHOST_PREPOCESS=172.17.0.1, VIPERPORT_PREPROCESS=45055, VIPERHOST_PREPOCESS2=172.17.0.1, VIPERPORT_PREPROCESS2=37913, VIPERHOST_PREPOCESS_PGPT=172.17.0.1, VIPERPORT_PREPROCESS_PGPT=46877, VIPERHOST_ML=172.17.0.1, VIPERPORT_ML=39033, VIPERHOST_PREDCT=172.17.0.1, VIPERPORT_PREDICT=42367, HPDEHOST=172.17.0.1, HPDEPORT=44457, HPDEHOST_PREDICT=172.17.0.1, HPDEPORT_PREDICT=40763

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2737-project2-f2d7,solution_preprocessing_dag-project2-f2d7, python-preprocess-1155-project2-f2d7,solution_preprocessing_dag-project2-f2d7, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
